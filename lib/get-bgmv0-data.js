...
var getData = function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(vmid, status, typeNum, pn, coverMirror) {
    var _response$data2;
    var response;
...
var processData = function () {
  var _ref3 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3(vmid, status, showProgress, typeNum, coverMirror) {
...
module.exports.getBgmv0Data = function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          if (pagination) {
            ...
            extraPath = path.join(dataDir, "extra_".concat(CONSTANTS.TYPE_EN[type], "s.json"));

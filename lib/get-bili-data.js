...
var getData = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(vmid, status, useWebp, typeNum, pn, coverMirror) {
    var _response$data5;
  ...
  return function getData(_x4, _x5, _x6, _x7, _x8, _x9) {
...
var processData = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(vmid, status, useWebp, showProgress, typeNum, coverMirror) {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          _context3.next = 12;
          return getData(vmid, status, useWebp, typeNum, i, coverMirror);
        case 12:
          data = _context3.sent;
  ...
  return function processData(_x10, _x11, _x12, _x13, _x14, _x15) {
...
module.exports.getBiliData = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(_ref4) {
    var vmid, type, showProgress, sourceDir, extraOrder, pagination, _ref4$useWebp, useWebp, coverMirror, typeNum, startTime, wantWatch, watching, watched, endTime, bangumis, allBangumis, _JSON$parse, wantWatchExtra, watchingExtra, watchedExtra;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          vmid = _ref4.vmid, type = _ref4.type, showProgress = _ref4.showProgress, sourceDir = _ref4.sourceDir, extraOrder = _ref4.extraOrder, pagination = _ref4.pagination, _ref4$useWebp = _ref4.useWebp, useWebp = _ref4$useWebp === void 0 ? true : _ref4$useWebp, coverMirror = _ref4.coverMirror;
          typeNum = type === 'cinema' ? 2 : 1;
          log.info("Getting bilibili ".concat(type, ", please wait..."));
          startTime = new Date().getTime();
          _context4.next = 6;
          return processData(vmid, 1, useWebp, showProgress, typeNum, coverMirror);
        case 6:
          wantWatch = _context4.sent;
          _context4.next = 9;
          return processData(vmid, 2, useWebp, showProgress, typeNum, coverMirror);
        case 9:
          watching = _context4.sent;
          _context4.next = 12;
          return processData(vmid, 3, useWebp, showProgress, typeNum, coverMirror);
        case 12:

...
function getDataPage(_x, _x2, _x3) {
  return _getDataPage.apply(this, arguments);
}

function _getDataPage() {
  _getDataPage = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(vmid, status, typeNum) {
...
function getData(_x4, _x5, _x6, _x7, _x8) {
  return _getData.apply(this, arguments);
}

function _getData() {
  _getData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(vmid, status, useWebp, typeNum, pn) {
    var _response$data5;
...
function processData(_x9, _x10, _x11, _x12, _x13) {
  return _processData.apply(this, arguments);
}

function _processData() {
  _processData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(vmid, status, useWebp, showProgress, typeNum) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            list = [];
            bar = null;
            if (showProgress) bar = new ProgressBar("\u6B63\u5728\u83B7\u53D6 ".concat(status === 1 ? '[想看]' : status === 2 ? '[在看]' : '[已看]', " ").concat(typeNum === 1 ? '番剧' : '追剧', " [:bar] :percent :elapseds"), {
              total: page.data - 1,
              complete: '█'
            });
            i = 1;
          ...
          case 20:
            console.log('Get ' + (typeNum === 1 ? 'bangumi' : 'cinema') + ' data error:', page === null || page === void 0 ? void 0 : page.data);
...
module.exports.getBiliData = /*#__PURE__*/function () {
  var _getBiliData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(vmid, type, showProgress, sourceDir) {
    var useWebp,
        typeNum,
        startTime,
        wantWatch,
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            useWebp = _args.length > 4 && _args[4] !== undefined ? _args[4] : true;
          ...
          case 12:
            ...
            fs.writeFile(path.join(sourceDir, '/_data/' + type + 's.json'), JSON.stringify(bangumis), function (err) {
              if (err) {
  ...
  function getBiliData(_x14, _x15, _x16, _x17) {
    return _getBiliData.apply(this, arguments);
  }

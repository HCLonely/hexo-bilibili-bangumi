...
function _withRetry() {
  _withRetry = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee5(apiCall) {
    var retries,
      i,
      _args5 = arguments,
      _t2;
...
var getDataPage = function () {
  var _ref = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(vmid, status, typeNum) {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return withRetry(function () {
            return axios.get("".concat(CONSTANTS.API.BASE_URL, "?playform=web&type=").concat(typeNum, "&follow_status=").concat(status, "&vmid=").concat(vmid, "&ps=1&pn=1"));
          });
        case 1:
          response = _context.sent;
          if (!((response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.code) === 0 && (response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.message) === 'OK' && (response === null || response === void 0 || (_response$data3 = response.data) === null || _response$data3 === void 0 || (_response$data3 = _response$data3.data) === null || _response$data3 === void 0 ? void 0 : _response$data3.total) !== undefined)) {
            _context.next = 2;
            break;
          }
...
var getData = function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(vmid, status, useWebp, typeNum, pn, coverMirror, SESSDATA) {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return withRetry(function () {
            return axios({
              method: 'GET',
              url: "".concat(CONSTANTS.API.BASE_URL, "?playform=web&type=").concat(typeNum, "&follow_status=").concat(status, "&vmid=").concat(vmid, "&ps=").concat(CONSTANTS.API.PAGE_SIZE, "&pn=").concat(pn),
              headers: {
                Cookie: SESSDATA ? "SESSDATA=".concat(SESSDATA, ";") : null
              }
            });
          });
        case 1:
...
var processData = function () {
  var _ref3 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3(vmid, status, useWebp, showProgress, typeNum, coverMirror, SESSDATA) {
...
module.exports.getBiliData = function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee4(_ref4) {

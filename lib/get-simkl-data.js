...
var _fetchWithRetry = function () {
  var _ref = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(status, config, type) {
    var retries,
      response,
      _args = arguments,
      _t;
...
var getData = function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(config, coverMirror, type) {
...
module.exports.getSimklData = function () {
    ...
    return _regenerator["default"].wrap(function (_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _vmid$split = vmid.split('-'), _vmid$split2 = (0, _slicedToArray2["default"])(_vmid$split, 2), clientId = _vmid$split2[0], token = _vmid$split2[1];
          _context4.next = 2;
          return getData({
            token: token,
            clientId: clientId

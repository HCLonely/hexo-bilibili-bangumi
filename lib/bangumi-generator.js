...
module.exports = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(locals) {
    var _config$bangumi, _config$bangumi2;

    var config, root, wantWatch, watching, watched, _JSON$parse, wantWatchExtra, watchingExtra, watchedExtra, _JSON$parse2, __, ejsFile, contents;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (config !== null && config !== void 0 && (_config$bangumi = config.bangumi) !== null && _config$bangumi !== void 0 && _config$bangumi.enable) {
              _context.next = 3;
              break;
            }
          ...
          case 3:
            ...
            ejsFile = config !== null && config !== void 0 && (_config$bangumi2 = config.bangumi) !== null && _config$bangumi2 !== void 0 && _config$bangumi2.bgmtv ? 'templates/bangumi-tv.ejs' : 'templates/bangumi.ejs';
            log.info('use ' + ejsFile);
            _context.next = 14;
            return ejs.renderFile(path.join(__dirname, ejsFile), {
